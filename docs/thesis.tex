...
Steengogogo dolor sit amet, consectetur adipiscing elit. Nam et turpis
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{using}\NormalTok{ namespe}
\NormalTok{efef}
\KeywordTok{function}\NormalTok{ f}
\KeywordTok{end}
\end{Highlighting}
\end{Shaded}
...
\end{aligned} \label{eq:my_complicated_equation}\end{equation}
...
\hypertarget{sec:mylabel}{%
\section{Conclusion}\label{sec:mylabel}}

\(\tau\) This is the conclusion to the chapter. Quisque nec purus a quam
...
faucibus. (Section \ref{sec:mylabel})
