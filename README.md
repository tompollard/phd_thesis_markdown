...
- all of the templates in this framework could be improved. The PDF output is acceptable as it is, but HTML and Word need work if you plan to use these formats.
